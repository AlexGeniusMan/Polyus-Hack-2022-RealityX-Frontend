...
import {ComposedChart, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, Scatter, Area} from 'recharts'
            ...
            <ResizableBox resizable={false} height={350} width={width}>
                <ResponsiveContainer>
                    ...
                    >
                        ...
                        <Area type="monotone" name='Data 1' dataKey="uv" fill={'red'} fillOpacity={0.2} stroke="red" />
